    ...
    <div className="mb-4">
        ...
        {type === 'select' ? (
            <select
                ...
                value={value}
                onChange={onChange}
                className="mt-1 block w-full rounded-md border-2 border-black shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-black"
                style={{minWidth: '400px'}} // Increase the width of the input box
            >
                {options.map((option) => (
            ...
            <input
                ...
                value={value}
                onChange={onChange}
                className="mt-1 block w-full rounded-md border-2 border-black shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                style={{minWidth: '400px'}} // Increase the length of the input box
            />
        )}
    </div>
);
...
export default function Home() {
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            <h1 className="text-4xl font-bold mb-8 text-center text-indigo-700">Genetic Prediction App</h1>
            <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="bg-white p-6 rounded-lg shadow-md">
                    <h2 className="text-2xl font-semibold mb-6 pb-2 border-b-2 border-indigo-500 text-indigo-600">Patient Details</h2>
                    ...
                    <InputField label="White Blood cell count (thousand per microliter)" name="whiteBloodCellCount" type="number" value={patientData.whiteBloodCellCount} onChange={handleInputChange} tooltip={tooltips.whiteBloodCellCount} />
                    ...
                    <div className="mt-6">
                        ...
                        {showAdditionalInfo && (
                            <div className="mt-4 bg-gray-50 p-4 rounded-md">
                                <h3 className="text-lg font-medium mb-3 text-indigo-600">Additional Information</h3>
                ...
                <div className="bg-white p-6 rounded-lg shadow-md">
                    <h2 className="text-2xl font-semibold mb-6 pb-2 border-b-2 border-indigo-500 text-indigo-600">Family Medical History</h2>
                ...
                <div className="col-span-1 md:col-span-2 text-center mt-8">
                    <button
                        type="submit"
                        className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-6 rounded-lg focus:outline-none focus:shadow-outline transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-110"
                    >
                        Predict
                    </button>
                </div>
